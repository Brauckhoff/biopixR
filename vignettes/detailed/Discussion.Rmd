...
(ref:DSB3) **Quantification of γH2AX Foci per Cell**: The bar plot displays the results of quantitative foci extraction from cellular images using the `biopixR` package. It shows the distribution of $\gamma$H2AX foci per cell, revealing that most cells exhibit few or no DNA double-strand breaks, indicated by the absence of $\gamma$H2AX foci. The frequency of events (number of foci per cell) is plotted to illustrate this distribution.
