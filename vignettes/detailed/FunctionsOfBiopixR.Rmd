...
`magick` and `imager` packages. Since most image processing operations in
...
analysis, the function incorporates a verification process to ensure that the
...
representing the results for this analysis (see Figure \@ref(fig:scan4)). The
