...
```{r shape2, out.width="89%", fig.cap="(ref:shape2)", echo=FALSE, fig.pos="H"}
...
employed for comparison (see Figure \@ref(fig:shape3)). The aspect ratio (AR)
...
(ref:shape3) **Circles with different Aspect Ratios**: This is a modified image, originally derived from the publication of @Takashimizu2016.
...
resulting output is presented in Table \@ref(tab:haralickCluster1). The results
...
\@ref(fig:haralickCluster3). The results presented in Table \@ref(tab:haralickCluster1)
...
another, as depicted in Figure \@ref(fig:haralickCluster3).
