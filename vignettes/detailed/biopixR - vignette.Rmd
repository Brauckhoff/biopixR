...
```{r}
knitr::include_graphics("Figures/final_logo.png")
```

```{r eval=FALSE}
par(mfrow = c(1, 2))

img <- importImage("tim_242602_c_s6c1+2+3m3.tif")
plot(img)
...
## Quantitative Analysis of Biological Images with Focus on DSB and Microbeads

### Imaging Double Strand Breaks
...
# Case study for the Application of the `biopixR` package


```{r}
library(imager)

circ <- load.image("Figures/analysis_circularity3.png")

test <- biopixR::shapeFeatures(grayscale(circ), sigma = 2)
