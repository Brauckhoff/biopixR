...
The `biopixR` package was initially developed for the analysis of microbeads, as
demonstrated in the latest use case for quality control of microbeads
[@Geithe2024]. However, its applications can be extended to any research
...
All technical and experimental aspects of `biopixR` should adhere to the
...
Given that the `biopixR` package is still relatively new, there is considerable
...
We would like to express our gratitude to Dr. Franziska Dinter and Coline
Kieffer for providing the microbead images and conducting the related
experiments. Their contributions were essential for the development and testing
