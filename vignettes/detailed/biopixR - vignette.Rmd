...
```{r static, echo=FALSE, fig.cap="(ref:static)", out.width="99%", fig.pos="ht", fig.align='center'}
...
```{r uncert, echo=FALSE, fig.cap="(ref:uncert)", out.width="99%", fig.pos="ht", fig.align='center'}
include_graphics("figures/fig18_uncertainty_plot.png")
```

```{r pareto, echo=FALSE, fig.cap="(ref:pareto)", out.width="99%", fig.pos="ht", fig.align='center'}
