...
volumes of imagedata, encompassing key aspects such as image processing, machine
learning, data management, and quantitative analysis. 
...
comparing pixel values against one or more intensity thresholds, which typically
...
microbeads in a recent case study [@Geithe2024]. The `biopixR` package has
