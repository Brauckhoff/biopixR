...
and data science. The core contributors are listed in the `DESCRIPTION` file of the
`biopixR` package. `R`'s active community has developed numerous packages for a
