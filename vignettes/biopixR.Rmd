...
interquartile range (IQR).To simplify the selection of limits in cases where the
number of detected objects is insufficient, the function will terminate and
  ...
  for (j in 1:num_points) {
    if (i == j) {
      ...
      relative_distances[i, j] <-
        euclidean_distance(res_proximityFilter$centers[i, ],
