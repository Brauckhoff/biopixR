#' Pixel Interpolation
#'
#' Connects to points in a matrix, array or an image
...
#' @param row2 second column: together with col2 coordinate for the second point
#' @param col2 second column: together with row2 coordinate for the second point
#' @returns
#' data frame containing the coordinates to connect the two input points
#' @examples
#' test <- matrix(0, 4, 4)
#' test[1, 1] <- 1
#' test[3, 4] <- 1
